export const politique = [
  { label: "footer.mentions.legal", href: "/mentions-legales" },
  { label: "footer.mentions.privacy", href: "/confidentialite" },
];

export const services = [
  { label: "footer.services.seo-geo", href: "/services/seo-geo" },
  { label: "footer.services.sea-smo", href: "/services/sea-smo" },
];
...
export const social = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/seofyagency",
    icon: (
      <svg
        viewBox="0 0 24 24"
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/seofy.io/",
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-[18px] h-[18px]"
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@seofyagencyio?",
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="w-[18px] h-[18px]"
